...
public class Poissonier : PlayerClass
{
    public Poissonier(string name) : base(name)
    {
        ...
        {
            { "Maquereau", (500, 6.75, true, 1, 3) },
            { "Sardine", (500, 4.25, true, 1, 3) },
            { "Coquilles saint jacques", (500, 5.50, true, 1, 3) },
            { "Sole", (500, 14, true, 1, 3) },
            { "Merlan", (500, 8.50, true, 1, 3) },
            { "Hareng", (500, 9.00, true, 1, 3) },
