...
public class Bijouterie : PlayerClass
{
    public Bijouterie(string name) : base(name)
    {
        ...
        {
            { "Bague en argent", (50, 35, true, 1, 500) },
            { "Bracelet en argent", (50, 40, true, 1, 500) },
            { "Boucles d'oreilles en argent", (50, 20, true, 1, 500) },
            { "Bague breloque", (50, 15, true, 1, 500) },
            { "Chaine en argent", (50, 18, true, 1, 500) },
            { "Bracelet en acier", (50, 30, true, 1, 500) },
