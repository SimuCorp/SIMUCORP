...
public class Libraire : PlayerClass
{
    public Libraire(string name) : base(name)
    {
		...
		for (int i = 0; i < 6; ++i)
			_items.Add("NaN");
        _missingitems = new List<string> { "Encyclopédie", "Livre Dédicacé", "Bande Dessinée", "Saga Fantastique", "Roman Horreur", "Livre Broché"};
