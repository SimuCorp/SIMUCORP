...
public class TextTuto : NetworkBehaviour
{
    ...
    public static List<string> Script = new List<string> {
        "Bienvenue dans notre tutoriel. Pour commencer, réapprovisionnez votre magasin. Pour ce faire, touchez une case contenant un produit, puis seléctionner avec les flèches du haut et du bas l'onglet quantité, et enfin appuyer sur entrer pour réaliser l'action souhaitée.",
        "Bien, de plus vous pouvez aussi modifier le prix et qualité de vos produits. Pour changer d'options, utilisez les flèches verticales. Attention, appuyer sur entrer sur un menu contenant des flèches de modifira pas la statistique correspondante. A la place appuyez sur les flèches latérales.",
        ...
        "Vous avez aussi la possibilité de faire des actions commerciales pour améliorer votre attractivité. Ces actions sont disponibles à la table ayant un cadeau.",
        ...
        "Toutes les actions que vous ferez lors de votre aventure auront un impact sur votre score final. Pour conclure ce tutoriel finissez votre tour."
                                                           };
